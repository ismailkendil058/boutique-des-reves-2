    ...
    <div className="min-h-screen flex bg-[#F2F2F2]">
      ...
      <aside className="hidden lg:flex w-[260px] flex-col bg-white border-r border-[#F0EEEC] py-10 px-6">
        <div className="mb-10 px-3">
          <div className="brand-name font-light tracking-[0.18em] uppercase text-neutral-800" style={{ fontSize: 22 }}>Boutique des Rêves</div>
      ...
      {mobileOpen && (
        <div className="lg:hidden fixed inset-0 z-50" onClick={closeMobile}>
          ...
          >
            <div className="mb-10 px-3">
              <div className="brand-name font-light tracking-[0.18em] uppercase text-neutral-800" style={{ fontSize: 20 }}>Boutique des Rêves</div>
              <div className="text-[10px] uppercase tracking-[0.15em] text-neutral-400 mt-1.5">Gestion de Luxe</div>
            </div>
